...
**What to do:**
- [ ] Create new file
- [ ] Define `Theme` struct with all fields
- [ ] Add `CodingKeys` for snake_case conversion
- [ ] Make it `Identifiable` and `Codable`
...
**What to do:**
- [ ] Add `requiredFields: ModelRequirements?` property
- [ ] Add to `CodingKeys`: `case requiredFields = "required_fields"`
...
**What to do:**
- [ ] Create new file
- [ ] Define `ThemeServiceProtocol`
- [ ] Implement `ThemeService` class
- [ ] Add `fetchThemes()` method
- [ ] Add `fetchThemeDetail(id:)` method
- [ ] Use same pattern as `ModelService`
...
**What to do:**
- [ ] Add `fetchActiveModel()` method to protocol
- [ ] Implement method:
...
**What to do:**
- [ ] Replace `ModelServiceProtocol` with `ThemeServiceProtocol`
- [ ] Change `featuredModels` to `featuredThemes: [Theme]`
- [ ] Change `allModels` to `allThemes: [Theme]`
- [ ] Update `loadData()` to fetch themes instead of models
- [ ] Update `filteredModels` computed property to `filteredThemes`
...
- [ ] Update carousel to use `viewModel.featuredThemes`
- [ ] Update grid to use `viewModel.filteredThemes`
- [ ] Update navigation: `ModelDetailView(themeId: selectedThemeId)`
- [ ] Update card components to use `Theme` instead of `ModelPreview`
...
**What to do:**
- [ ] Change `modelId: String` to `themeId: String`
- [ ] Add `theme: Theme?` published property
- [ ] Add `activeModel: ModelDetail?` published property
- [ ] Add `themeService: ThemeServiceProtocol`
- [ ] Update `loadModelDetail()`:
...
- [ ] Change `modelId: String` to `themeId: String`
- [ ] Update initializer
- [ ] Update header to show theme name (or active model name)
- [ ] Update description section to show theme description
- [ ] Keep prompt input (pre-filled from theme)
- [ ] Replace `SettingsPanel` with `DynamicSettingsPanel`
...
**What to do:**
- [ ] Create new file
- [ ] Copy structure from `SettingsPanel`
- [ ] Add `requiredFields: ModelRequirements?` parameter
- [ ] Show settings conditionally based on `requiredFields`
- [ ] Use options from `requiredFields.settings`
- [ ] Apply defaults from `requiredFields.settings`
...
**What to do:**
- [ ] Run app
- [ ] Verify HomeView shows themes (not models)
- [ ] Verify carousel shows featured themes
- [ ] Verify grid shows all themes
...
**What to do:**
- [ ] Tap a theme in HomeView
- [ ] Verify ModelDetailView opens
- [ ] Verify prompt field is pre-filled with theme's prompt
- [ ] Verify user can edit the prompt
...
**What to do:**
- [ ] Open ModelDetailView
- [ ] Verify settings panel shows correct options
- [ ] Verify options match active model's `required_fields`
...
- [ ] Adjust settings
- [ ] Tap Generate
- [ ] Verify backend receives modified prompt (check logs)
...
**What to do:**
- [ ] Generate video with different durations
- [ ] Verify cost changes for per_second pricing
- [ ] Check credit deduction is correct
- [ ] Verify cost matches: `base_price * duration * 100` (for credits)
...
**What to do:**
- [ ] Test missing prompt (if required)
- [ ] Test missing image_url (if required)
...
- [ ] Phase 3: Frontend Updates (Tasks 3.1 - 3.11)
